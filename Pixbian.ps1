...
.DESCRIPTION
    ...
    注意：输出路径按当前 TFM（net8.0-windows10.0.26100.0）、x64 平台与 RID 硬编码
    （csproj 为复制 FFmpeg 原生库设置了 RuntimeIdentifier=win-x64，故产物落在 win-x64 子目录），
    若修改 csproj 的 TargetFramework、平台或 RuntimeIdentifier 需同步更新。
#>
